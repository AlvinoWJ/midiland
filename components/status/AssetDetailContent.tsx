      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <DataRow label="Lebar Depan" value={lebar_depan} Icon={IconLebarPanjang} isEditing={isEditing} onChange={handleInputChange} dataKey="lebar_depan" type="number" unit="m" />
          ...
          <div className="space-y-3">
            {foto_lokasi && (
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                ...
                <a href={foto_lokasi} target="_blank" rel="noopener noreferrer"
