...
export const AssetDetailContent: React.FC<AssetDetailContentProps> = ({
  ...
  const assetTypeLabel =
    bentuk_objek ? bentuk_objek.charAt(0).toUpperCase() + bentuk_objek.slice(1) : "-";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <DataRow label="Kecamatan" value={kecamatan} Icon={IconKecamatan} isEditing={false} dataKey="kecamatan" />
              <DataRow label="Kelurahan" value={desa_kelurahan} Icon={IconKelurahan} isEditing={false} dataKey="desa_kelurahan" />
              <div className="col-span-2">
                <DataRow label="Alamat Detail" value={alamat} Icon={PinIcon} isEditing={false} dataKey="alamat" />
              </div>
              <div className="col-span-2">
          ...
          <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {bentuk_objek && bentuk_objek.toLowerCase() !== 'tanah' && (
                <DataRow label="Jumlah Lantai" value={floorCountDisplay} Icon={IconLantai} isEditing={false} dataKey="jumlah_lantai" />
              )}
              <DataRow label="Lebar Depan" value={lebar_depan} Icon={IconLebarPanjang} isEditing={false} dataKey="lebar_depan" unit="m" />
              <DataRow label="Panjang" value={panjang} Icon={IconLebarPanjang} isEditing={false} dataKey="panjang" unit="m" />
              <DataRow label="Luas Tanah" value={luas} Icon={IconLuasTanah} isEditing={false} dataKey="luas" unit="m²" />
            </div>
          ...
          <div className="bg-white rounded-xl p-5 shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
            ...
            <div className="space-y-4">
              <DataRow label="Nama Pemilik" value={nama_pemilik} Icon={IconNamaPemilik} isEditing={false} dataKey="nama_pemilik" />
              <DataRow label="Kontak Pemilik" value={kontak_pemilik} Icon={IconKontakPemilik} isEditing={false} dataKey="kontak_pemilik" />
            </div>
          </div>
